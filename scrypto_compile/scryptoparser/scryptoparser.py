...
Call scrytoparser.init(parser: ArgumentParser) to setup all the scryto-compile arguments in the argument parser
"""
from argparse import ArgumentParser

from scryto_compile.scryto_compile import get_platforms
from scryto_compile.scrytoparser import DEFAULTS_FLAG_IN_CONFIG


def init(parser: ArgumentParser) -> None:
    """Add scryto-compile arguments to the parser
...
def _init_etherlime(parser: ArgumentParser) -> None:
    ...
    group_etherlime.add_argument(
        ...
        "(note: [dir] is the the directory provided to scryto-compile)",
        action="store_true",
...
def _init_buidler(parser: ArgumentParser) -> None:
    ...
    group_buidler.add_argument(
        ...
        help="Disable directory name fix (see https://github.com/khulnasoft-lab/scryto-compile/issues/116)",
        action="store_true",
