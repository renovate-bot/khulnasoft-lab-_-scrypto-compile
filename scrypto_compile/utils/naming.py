...
def convert_filename(
    ...
    scryto_compile: "ScrytoCompile",
    working_dir: Optional[Union[str, Path]] = None,
) -> Filename:
    """Convert a filename to ScrytoCompile Filename object.
    ...
    if scryto_compile.package_name:
        try:
            filename = filename.relative_to(Path(scryto_compile.package_name))
        except ValueError:
            pass
