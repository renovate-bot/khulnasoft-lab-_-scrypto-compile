...
# Handle cycle
from scryto_compile.platform.solc import relative_to_short
...
def hardhat_like_parsing(
    scryto_compile: "ScrytoCompile", target: str, build_directory: Path, working_dir: str
) -> None:
    """
    ...
    Args:
        scryto_compile: ScrytoCompile object
        target: target
    ...
    for file in files:
        ...
        compilation_unit = CompilationUnit(scryto_compile, uniq_id)
...
class Hardhat(AbstractPlatform):
    ...
    def compile(self, scryto_compile: "ScrytoCompile", **kwargs: str) -> None:
        ...
        hardhat_like_parsing(scryto_compile, self._target, build_directory, hardhat_working_dir)
    ...
    def _get_hardhat_paths(
        ...
        Args:
            ...
            args (Dict[str, str]): scryto-compile options that may affect paths
