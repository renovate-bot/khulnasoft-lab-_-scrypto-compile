...
from scryto_compile.platform.solc import Solc, get_version, is_optimized, relative_to_short
...
def standalone_compile(
    ...
    Example of usage:
        compilation_unit = CompilationUnit(scryto_compile, name_target)
...
class SolcStandardJson(Solc):
    ...
    # pylint: disable=too-many-locals
    def compile(self, scryto_compile: "ScrytoCompile", **kwargs: Any) -> None:
        """[summary]
        ...
        compilation_unit = CompilationUnit(scryto_compile, "standard_json")
