...
This gives the skeleton for any platform supported by scryto-compile
"""
import abc
from typing import TYPE_CHECKING, List, Dict, Optional
from dataclasses import dataclass, field

from scryto_compile.platform import Type
from scryto_compile.utils.unit_tests import guess_tests
...
class AbstractPlatform(metaclass=abc.ABCMeta):
    ...
    def compile(self, scryto_compile: "ScrytoCompile", **kwargs: str) -> None:
        ...
        Args:
            scryto_compile (ScrytoCompile): ScrytoCompile object associated with the platform
