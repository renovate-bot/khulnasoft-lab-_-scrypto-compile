...
from scryto_compile.platform import solc
...
from scryto_compile.utils.naming import convert_filename
...
def export_to_truffle(scryto_compile: "ScrytoCompile", **kwargs: str) -> List[str]:
    ...
    compilation_units = list(scryto_compile.compilation_units.values())
    ...
    libraries = compilation_unit.scryto_compile.libraries
...
class Truffle(AbstractPlatform):
    ...
    def compile(self, scryto_compile: "ScrytoCompile", **kwargs: str) -> None:
        ...
        # scryto_compile.type = Type.TRUFFLE
        ...
        for filename_txt in filenames:
            with open(filename_txt, encoding="utf8") as file_desc:
                ...
                # See https://github.com/khulnasoft-lab/scryto-compile/issues/199
                if filename.startswith("project:"):
                    filename = "." + filename[len("project:") :]

                try:
                    filename = convert_filename(
                        filename, _relative_to_short, scryto_compile, working_dir=self._target
                    )
